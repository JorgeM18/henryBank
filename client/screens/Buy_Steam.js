...
import { URL } from '@env' 
export default function Buy_Steam(props){
   ...
   const createAlert20=  ()=>{
    setState({ ...state, amount: 20, commerce: 'Steam'})
   Alert.alert(
...
const createAlert50=  ()=>{
    setState({ ...state, amount: 50, commerce: 'Steam'})
   Alert.alert(
       'Confirmacion de Compra',
       '¿Estas seguro de realizar esta compra?',[  {
        text: 'Cancel',
...
const createAlert100=  ()=>{
    setState({ ...state, amount: 100, commerce: 'Steam'})
   Alert.alert(
       'Confirmacion de Compra',
       '¿Estas seguro de realizar esta compra?',[  {
        text: 'Cancel',
    ...
    return(
        <View style={styles.MainContainer}>
            ...
            <TouchableOpacity style={styles.Steam_Style} activeOpacity={0.5}  onPress={createAlert20}>
            <Image
            ...
            <TouchableOpacity style={styles.Steam_Style} activeOpacity={0.5} onPress={createAlert50}>
            <Image
            source={require('./images/Steam_icono.png')}
            style={styles.ImageIconStyle}
            />
            ...
            <TouchableOpacity style={styles.Steam_Style} activeOpacity={0.5} onPress={createAlert100}>
            <Image
            source={require('./images/Steam_icono.png')}
            style={styles.ImageIconStyle}
            />
