...
const sequelize = new Sequelize(
    `postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/henrybank`,
    {
...
// usuario tiene muchas cuentas y la cuenta pertenece a un usuario
User.hasMany(Account)
Account.belongsTo(User);

// account tiene muchos movements. movement pertenece a un usuario
